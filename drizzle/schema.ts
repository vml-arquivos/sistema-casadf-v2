...
// ============================================
// TIPOS AUXILIARES PARA ENUMS DE LEAD
// ============================================

export type LeadSource = "site" | "whatsapp" | "instagram" | "facebook" | "indicacao" | "portal_zap" | "portal_vivareal" | "portal_olx" | "google" | "outro";
export type LeadStage = "novo" | "contato_inicial" | "qualificado" | "visita_agendada" | "visita_realizada" | "proposta" | "negociacao" | "fechado_ganho" | "fechado_perdido" | "sem_interesse";
export type LeadClientType = "comprador" | "locatario" | "proprietario";
export type LeadQualification = "quente" | "morno" | "frio" | "nao_qualificado";
export type LeadBuyerProfile = "investidor" | "primeira_casa" | "upgrade" | "curioso" | "indeciso";
export type LeadUrgencyLevel = "baixa" | "media" | "alta" | "urgente";
export type LeadTransactionInterest = "venda" | "locacao" | "ambos";
